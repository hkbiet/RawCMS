...
{
    [Verb("delete", HelpText = "Delete data inside collection. Type delete for more help.")]
    public class DeleteOptions
    {
        ...
        [Option('f', "file", SetName = "file", HelpText = "Fle contains data to delete into collection. it can be a json file well-formatted.")]
        public string FilePath { get; set; }

        [Option('d', "folder", SetName = "file", HelpText = "Folder contains data to delete into collection. it can be a json file well-formatted.")]
        public string FolderPath { get; set; }

        [Option('r', "recursive", Required = false, HelpText = "Fle path contains data to delete into collection. it can be a json file well-formatted.")]
